...
<title>ExamSys — Installation Wizard</title>
...
<body class="bg-installer min-h-screen flex flex-col items-center justify-center p-4 sm:p-8">
    ...
    <div class="w-full max-w-5xl">
        ...
        <div class="flex items-center gap-3 mb-5 px-1">
            ...
            <span class="text-white font-bold text-xl tracking-tight">{{ config('app.name', 'ExamSys') }}</span>
        ...
        <p class="text-center text-white/20 text-xs mt-5">{{ config('app.name', 'ExamSys') }} &copy; {{ date('Y') }} &nbsp;·&nbsp; All rights reserved</p>
    </div>

<x-filament-widgets::widget class="cc-widget">
    <div class="cc-card p-5">
        <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-4">{{ __('lecturer.dash_quiz_status') }}</h3>
        ...
        <div class="cc-donut" style="background: {{ $breakdown['gradient'] }}">
            <div class="cc-donut-hole">
                ...
                <span class="cc-donut-label">{{ __('lecturer.status_published') }}</span>
            </div>
        </div>

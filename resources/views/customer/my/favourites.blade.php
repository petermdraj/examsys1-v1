@extends('layouts.app')
@section('title', __('common.my_favourites_heading') . ' — Quizora')
...
.myf-free-badge{font-size:11px;font-weight:700;color:#6366f1;background:#ede9fe;padding:2px 8px;border-radius:20px;}
      ...
      <div class="card myf-card">
        ...
        <div class="myf-info">
          <div class="myf-badges">
            ...
            @else
              <span class="myf-free-badge">{{ __('common.free_badge') }}</span>
            @endif
          </div>

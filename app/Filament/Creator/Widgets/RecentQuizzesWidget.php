...
class RecentQuizzesWidget extends BaseWidget
{
    ...
    public function getHeading(): string { return __('creator.recent_quizzes_heading'); }
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('price')
                    ->formatStateUsing(fn ($state) => $state > 0 ? $sym . number_format((float) $state, 2) : __('creator.col_price_free'))
            ...
            ->actions([
                Tables\Actions\Action::make('edit')
                    ...
                    ->url(fn (Quiz $r) => route('filament.creator.resources.quizzes.edit', $r))
                    ->iconButton(),
            ])
            ->paginated(false);
    }

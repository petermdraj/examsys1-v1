...
class CreateQuiz extends CreateRecord
{
    ...
    {
        try {
            app(PlanLimitService::class)->assertCanCreateQuiz(auth()->user());
        } catch (PlanLimitExceededException $e) {
            Notification::make()->title(__('creator.notif_quiz_limit_reached'))->body($e->getMessage())->danger()->persistent()->send();
    ...
    /* ── Question CRUD — only usable after the quiz record exists ─── */

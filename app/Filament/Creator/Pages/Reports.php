...
class Reports extends Page
{
    ...
    public static function getNavigationLabel(): string { return __('creator.nav_reports'); }
    public function getTitle(): string { return __('creator.nav_reports'); }
    protected static ?int $navigationSort = 4;
    protected static string $view = 'filament.creator.pages.reports';

    public ?string $selectedQuizId = null;

    public function mount(): void
    {
        $this->selectedQuizId = request('quiz_id') ?? Quiz::where('creator_id', auth()->id())
    ...
    {
        $quizzes = Quiz::where('creator_id', auth()->id())->orderBy('title')->get();
        $quiz    = null;
        $stats   = null;

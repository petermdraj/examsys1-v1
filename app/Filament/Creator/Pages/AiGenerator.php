...
class AiGenerator extends Page
{
    ...
    public static function getNavigationLabel(): string { return __('creator.nav_ai_generator'); }
    protected static ?int $navigationSort = 2;
    protected static string $view = 'filament.creator.pages.ai-generator';
    ...
    public function mount(): void
    {
        ...
        $this->bankCollections = QuestionCollection::where('creator_id', auth()->id())

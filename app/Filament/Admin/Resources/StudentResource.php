...
class StudentResource extends Resource
{
    ...
    {
        return __('admin.nav_students');
    }

    public static function getModelLabel(): string
    {
        return __('admin.student_user_model_label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('admin.student_user_model_label_plural');
    }

    public static function getNavigationBadge(): ?string
    {
        return (string) User::query()->where('role', 'student')->count();
    }
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Section::make(__('admin.user_section_identity'))
                ->description(__('admin.student_user_section_desc'))
                ->columns(2)
                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('student_batch_id')
                    ->label(__('admin.user_col_batch'))
                    ->relationship('studentBatch', 'name', fn ($query) => $query->orderBy('name')),
            ...
            ->actions([
                Impersonate::make()
                    ...
                    ->redirectTo(fn () => route('home'))
                    ->backTo(route('filament.admin.resources.students.index')),

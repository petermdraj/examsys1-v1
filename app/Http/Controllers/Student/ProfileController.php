...
use App\Http\Requests\Student\DeleteAccountRequest;
...
class ProfileController extends Controller
{
    public function show()
    {
        ...
        return view('student.my.profile', compact('user'));
    }
    ...
    public function dashboard()
    {
        ...
        return view('student.my.dashboard', compact('user', 'attempts', 'enrolledCount', 'certsCount', 'passRate'));
    }
    ...
    public function quizzes()
    {
        ...
        return view('student.my.quizzes', compact('enrollments', 'latestAttempts'));
    }
    ...
    public function attempts()
    {
        ...
        return view('student.my.attempts', compact('attempts', 'status'));
    }
    ...
    public function favourites()
    {
        $favourites = auth()->user()
            ->favourites()
            ->with(['quiz.category', 'quiz.lecturer'])
            ->latest('created_at')
            ->paginate(12);

        return view('student.my.favourites', compact('favourites'));
    }
}
